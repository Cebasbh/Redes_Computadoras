...
class Log(ctk.CTk):
    def _init_(self):
        ...
        # Entry para mostrar el timestamp
        ...
        hashbutton.grid(row=6, column=4, padx=(0,20), pady=(2,0), sticky="e")

        copybutton = Button(master = self, text="Copy!", command = copiar, width = 130)
        copybutton.grid(row=6, column=3, padx=(0,5), pady=(2,0), sticky="e")
        ...
        label_timestamp.grid(row=4, column=0, padx=(20, 0), pady=(10, 0), sticky="w", columnspan=4)

        inform = Label(master = self, text="")
        inform.grid(row=6, column=0, padx=(25,0), pady=(1,0), columnspan=5, sticky="w" )
